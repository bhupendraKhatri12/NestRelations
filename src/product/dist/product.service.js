...
var ProductService = /** @class */ (function () {
    function ProductService(productrepo) {
    ...
    ProductService.prototype.create = function (createProductDto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productrepo.create(createProductDto)];
                    case 1:
                        newproduct = _a.sent();
    ...
    ProductService.prototype.update = function (id, updateProductDto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productrepo.update(id, updateProductDto)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.productrepo.findOne(id)];
                    case 2:
    ...
    ProductService = __decorate([
        common_1.Injectable(),
        __param(0, typeorm_1.InjectRepository(product_entity_1["default"]))
    ], ProductService);
